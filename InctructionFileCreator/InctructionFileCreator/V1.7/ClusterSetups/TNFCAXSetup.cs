...
namespace InctructionFileCreator.V1._7.ClusterSetups
{
    ...
    class TNFCAXSetup
    {
        ...
        public TNFCAXSetup()
        {
            ...
            List<string> prec_drivers = new List<string>();
            string file_gridlist = string.Empty;
            ...
            switch (cluster)
            {
                case Cluster.LRZ:
                    {
                        string message = "No valid cluster setup specified.";
            ...
            for (int pID = 0; pID < prec_drivers.Count; pID++)
            {
            ...
            for (int j = 0; j < psi50s.Data.Length; j++)
            {
                ...
                hyDriverFiles.File_prec = prec_drivers[pID];

                hyDriverFiles.File_gridlist = file_gridlist;
                ...
                writer.AddValue("maxKLeaf", maxKLeaf[0]);
