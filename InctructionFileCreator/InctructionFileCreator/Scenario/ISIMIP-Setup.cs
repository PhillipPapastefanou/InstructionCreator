...
namespace InctructionFileCreator.V1._7.ClusterSetups
{
    ...
    class ISIMIP_Setup_LRZ_v174
    {
        
        public ISIMIP_Setup_LRZ_v174(ref InsFileHydraulics hydFile, EarthSystemModelType esm_type, ScenarioType scenarioType)
        {
    ...
    class ISIMIP_Setup_AURORA_v174
    {

        public ISIMIP_Setup_AURORA_v174(ref InsFileHydraulics hydFile, EarthSystemModelType esm_type, ScenarioType scenarioType)
        {
            string basePath = "/home/papa/snic2022-6-59/phillip/input/ISIMIP-CMIP6/";
            string miscPath = "/home/papa/snic2022-6-59/phillip/input/Misc/";
            string gridlistPath = "/home/papa/snic2022-6-59/phillip/input/Gridlists/";
            ...
            if (scenarioType == ScenarioType.RCP_126)
            {
                hydFile.DriverFiles.File_Co2 = miscPath + "co2_rcp26.csv";
                scenario_type_str = "126";
            }
            ...
            if (scenarioType == ScenarioType.RCP_585)
            {
                hydFile.DriverFiles.File_Co2 = miscPath + "co2_1764_2100_extended_rcp85.dat";
                scenario_type_str = "585";
            }
            ...
            if (scenarioType == ScenarioType.RCP_370)
            {
                hydFile.DriverFiles.File_Co2 = miscPath + "co2_1764_2100_extended_ssp370.dat";
                scenario_type_str = "370";
            }
            ...
            if (scenarioType == ScenarioType.RCP_585_const)
            {
                hydFile.DriverFiles.File_Co2 = miscPath + "co2_1764_2100_extended_const2020.dat";
                scenario_type_str = "585";
            }
            ...
            hydFile.DriverFiles.Variable_prec = "prAdjust";
            hydFile.DriverFiles.Variable_insol = "rsdsAdjust";
            hydFile.DriverFiles.File_gridlist = gridlistPath + "Amazon/Amazon_basin_05.txt";
            ...
            hydFile.DriverFiles.File_Cru = miscPath + "Cruncep_1901_2015.bin";
            hydFile.DriverFiles.File_Cru_Misc = miscPath + "Cruncep_1901_2015misc.bin";
